...
This document records a subject-reported phenomenological, spiritual, and project-canon model. It does not independently establish that body, mind, identity, and soul are literally separable entities, and it does not replace ordinary sleep physiology or medical evidence.
...
**Content:** videos, streams, clips, manga, radio, podcasts, scripts, images, captions, playlists, platform-specific metrics.  
...
`PRIVATE EXCHANGES ≠ PUBLISHED CONTENT ≠ DOCUMENTED WORSHIP`

Private material remains sealed by default. Published material is intentionally public-facing. Worship classification requires deliberately documented ritual or devotional conduct; ordinary audience attention or platform metrics do not qualify by themselves.
